...
fun TipCalculatorApp(modifier: Modifier = Modifier) {
    ...
    val tip     = calculateTip(billAmount = amount, tipPercent = percent, roundUp = roundUp)
...
private fun calculateTip(billAmount: Double, tipPercent: Double = 15.0, roundUp: Boolean): String {
